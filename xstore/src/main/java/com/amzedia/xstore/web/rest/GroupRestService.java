...
public class GroupRestService {
	...
	/**
	 * This api will bring the group
	 * information by passing id of group
	 * 
	 * @param String
	 * @return Group
	 */
	...
	@ResponseBody public Group getGroupById(@PathVariable String id) {
	...
	@ResponseBody public boolean addGroup(@RequestBody Group group) {
