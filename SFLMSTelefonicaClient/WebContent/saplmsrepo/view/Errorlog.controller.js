sap.ui.core.mvc.Controller.extend("LMS_ODATA3.view.Errorlog", {
	...
	onSelect: function(oEvent) {
		...
		var offering = "";
		if(type === "04" || type === "05" || type === "06" || type === "07" || type === "08"){
			offering = "NewOffering";
		
		}else if(type === "09" || type === "10"){
			offering = "CompletedOffering";
			 selectedid.push(offering);
			 selectedid.push(type);
		}
		var validationUrl =this.getOwnerComponent().getMetadata().getConfig().serviceConfig.overview.validation;
		var statusURL = this.getOwnerComponent().setURLParameters( validationUrl,[offering, type]);
		
	var oJsonModel = new sap.ui.model.json.JSONModel();	
	oJsonModel.loadData(statusURL);
